          ...
          <View>
            ...
            <View style={styles.quickActions}>
              <View style={styles.actionItem}>
                ...
                <Text style={styles.actionText}>Birth</Text>
              </View>
              ...
              <View style={styles.actionItem}>
                ...
                <Text style={styles.actionText}>6 Weeks</Text>
              </View>
              ...
              <View style={styles.actionItem}>
                ...
                <Text style={styles.actionText}>10 Weeks</Text>
              </View>
              ...
              <View style={styles.actionItem}>
                ...
                <Text style={styles.actionText}>14 Weeks</Text>
              </View>
              ...
              <View style={styles.actionItem}>
                ...
                <Text style={styles.actionText}>6 Months</Text>
              </View>
              ...
              <View style={styles.actionItem}>
                ...
                <Text style={styles.actionText}>9 Months</Text>
              </View>
            </View>
            ...
            <View style={styles.formContainer}>
              ...
              <View style={styles.formRow}>
                <Text style={styles.formLabel}> Preferred Vaccine(s)*</Text>
                <TextInput style={styles.formInput} />
              </View>
              ...
              <View style={styles.vaccinesDescription}>
                <Text style={styles.vaccinesDesTitle}>Birth</Text>
...
export default VaccinesPediatric;
