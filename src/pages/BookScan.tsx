...
<View>
  ...
  <View style={styles.formContainer}>
    ...
    <View style={styles.vaccinesDescription}>
      <Text style={styles.vaccinesDesTitle}>Cervical L ength Measurement</Text>
      <Text style={styles.vaccinesDesText}>
      During a cervical length scan, an ultrasound is used to measure 
the length of the cervix. The procedure is typically performed 
transvaginally, as this provides a more accurate measurement 
compared to an abdominal ultrasound. The ultrasound probe is 
inserted into the vagina to visualize and measure the length of 
the cervix.
      </Text>
    </View>
